...
pub async fn get_transform_job_dto(
    client: &mongodb::Client,
    job_id: &String,
    token: String,
) -> Result<TransformJobDto, &'static str> {
...
pub async fn _get_transform_job_dto(
    client: &mongodb::Client,
    job_id: &str,
) -> Result<TransformJobDto, &'static str> {
...
pub async fn get_transform_job_model(
    client: &mongodb::Client,
    job_id: &str,
    token: &str,
) -> Result<TransformJobModel, &'static str> {
...
pub async fn _get_transform_job_model(
    client: &mongodb::Client,
    job_id: &str,
) -> Result<TransformJobModel, &'static str> {
    let jobs = get_transformations(client);
...
pub async fn create_new_transform_job(
    client: &mongodb::Client,
    create_job: CreateTransformJobDto,
) -> Result<(TransformJobDto, TransformJobModel), &'static str> {
...
pub async fn save_new_transform_job(
    client: &mongodb::Client,
    job: TransformJobModel,
) -> Result<(TransformJobDto, TransformJobModel), &'static str> {
    let jobs = get_transformations(client);
