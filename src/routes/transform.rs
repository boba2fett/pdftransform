...
use crate::{
    ...
    persistence::{create_new_transform_job, get_transform_job_dto, DbClient},
};
...
pub async fn transform_job(
    ...
    token: String,
    client: &DbClient,
) -> Result<Json<TransformJobDto>, NotFound<&'static str>> {
...
pub async fn create_transform_job(
    db_client: &DbClient,
    create_job: Json<CreateTransformJobDto>,
) -> Result<Json<TransformJobDto>, Conflict<&'static str>> {
